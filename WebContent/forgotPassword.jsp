...
<body oncontextmenu='return false' class='forget_password_Body'>
	<div class="container padding-bottom-3x mb-2 mt-5">
		<div class="row justify-content-center">
			<div class="col-lg-8 col-md-10">
				...
				<form  class="emailBox" action="ForgetPasswordServlet" method="POST">
					<div class="card-body">
					...
					<div class="card-footer">
						<div class="footerColor">
							<button class="btn btn-success forgetPasswordButtons"
