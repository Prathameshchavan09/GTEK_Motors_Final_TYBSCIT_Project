...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
	...
	<div class="card-group">
		<div class="card">
			...
			<div class="card-body">
				...
				<form action="DetailsProductPage.jsp">
				
				<input type="submit" class="form-control btn btn-primary" value="More Details">
		...
		<div class="card">
			<div class="ProductMiddleImage">
				...
				<div class="card-body">
					<h5 class="card-title">Arch Trimmer</h5>
	...
	<div class="card-group">
		...
		<div class="card">
			...
			<div class="card-body">
				<h5 class="card-title">12 Volt DC motor</h5>
				<p class="card-text">We are involved in offering a wide range of
					A.C. V.F.D. Drives to our most valued clients. Our range of these
					are widely appreciated by our clients which are situated all round
					the nation. We offer our range of it at most affordable prices.
		...
		<div class="card">
			...
			<div class="card-body">
				<h5 class="card-title">D.C Power Supply</h5>
				<p class="card-text">We are involved in offering a wide range of
					A.C. V.F.D. Drives to our most valued clients. Our range of these
					are widely appreciated by our clients which are situated all round
					the nation. We offer our range of it at most affordable prices.
	...
	<div class="card-group">
		...
		<div class="card">
			...
			<div class="card-body">
				<h5 class="card-title">D.C Drives Motors</h5>
				<p class="card-text">We are involved in offering a wide range of
					A.C. V.F.D. Drives to our most valued clients. Our range of these
					are widely appreciated by our clients which are situated all round
					the nation. We offer our range of it at most affordable prices.
		...
		<div class="card">
			...
			<div class="card-body">
				<h5 class="card-title">A.C Flange Motor</h5>
				<p class="card-text">We are involved in offering a wide range of
					A.C. V.F.D. Drives to our most valued clients. Our range of these
					are widely appreciated by our clients which are situated all round
					the nation. We offer our range of it at most affordable prices.
